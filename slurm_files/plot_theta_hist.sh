#!/bin/bash
#SBATCH -J plotting            # Identificação do job
...
echo "rodandrodandoo"
singularity exec ../singularity/Singularity_wavemixing.simg $PYTHON_EXEC -m post_processing.local_plotting.plot_theta_angles_hist
