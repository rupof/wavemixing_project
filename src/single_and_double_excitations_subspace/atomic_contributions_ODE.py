...
def F_beta_single_exc(N, l, Beta1D, Delta1D, Omega1D, Gamma2D, Delta2D):
    ...
    return (1j*Delta1D[l]-Gamma2D[l][l]/2)*Beta1D[l]-1j*Omega1D[l]/2-SumG_1D(N, G_val, Beta1D, l)

def F_beta_double_exc(N, k, l, Beta1D, Beta2D, Delta1D, Omega1D, Gamma2D, Delta2D):
    Gval = G(Gamma2D, Delta2D)
    ...
    total_sum += -SumG_2D_first_term(N, Gval, Beta2D, k, l)
    total_sum += -SumG_2D_second_term(N, Gval, Beta2D, k, l)
